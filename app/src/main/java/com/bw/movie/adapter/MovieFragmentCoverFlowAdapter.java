 ...
 * function:
 */
public class MovieFragmentCoverFlowAdapter extends RecyclerView.Adapter<MovieFragmentCoverFlowAdapter.MyViewHolder> {

    Context context;
    List<MovieFragmentBean.ResultBean> list;

    public MovieFragmentCoverFlowAdapter(Context context, List<MovieFragmentBean.ResultBean> list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = View.inflate(context, R.layout.moviefragment_cover_item, null);
